...
同じコマンドが連続して送信された場合はまとめて記載する。次のように記した場合、「電源ボタン押下後から10.2秒後から10.5秒後までに」「通算30番目から33番目までのTPMコマンドとして連続して」「`TPM2_PCR_Extend`コマンドが送信された」ことを意味する。
